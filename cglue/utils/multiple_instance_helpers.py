...
def add_instance_check(
    body_to_wrap, component_instance: ComponentInstance, instance_arg_name="instance"
):
    return (
        f"if ({instance_arg_name} == &{component_instance.instance_var_name})\n"
        f"{{\n"
